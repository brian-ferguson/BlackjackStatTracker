...
def simulate_single_configuration(deck_count, penetration, num_shoes):
    ...
    print(f"Simulating {deck_count} deck(s), penetration {penetration}, {num_shoes} shoes...")
...
if __name__ == "__main__":
    # Test with 1 deck, no penetration, 1 shoe
    result_file = simulate_single_configuration(1, 0, 1)
    
    print(f"\nShowing first 15 lines of output:")
